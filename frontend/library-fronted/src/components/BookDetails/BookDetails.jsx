...
function BookDetails() {
  ...
  useEffect(() => {
    fetch(`http://[2a01:4f8:c013:c304::1]:3000/api/books/${isbn}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleCheckOut = async () => {
    ...
    const responseBorrowing = await fetch(`http://[2a01:4f8:c013:c304::1]:3000/details/borrow/${isbn}`, {
      method: 'POST',
      headers: {
  ...
  const handleBookUp = async () => {
    ...
    const responseOrder = await fetch(`http://[2a01:4f8:c013:c304::1]:3000/details/order/${isbn}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
